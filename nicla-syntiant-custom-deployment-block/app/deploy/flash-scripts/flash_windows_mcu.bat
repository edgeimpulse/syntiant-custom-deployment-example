...
set ARDUINO_CORE_VERSION=3.5.5
...
(arduino-cli core list  2> nul) | findstr /r "%ARDUINO_CORE%.*%ARDUINO_CORE_VERSION%"
IF %ERRORLEVEL% NEQ 0 (
    echo Installing Nicla board ...
    arduino-cli core update-index
    arduino-cli core install %ARDUINO_CORE%@%ARDUINO_CORE_VERSION%
